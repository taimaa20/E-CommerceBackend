...
{
    [ApiController]
    [Route("api/mobile/leave-requests")]
  
    [Authorize]
    [EnableRateLimiting("api")]
    public class MobileLeaveRequestsController : ControllerBase
    {
        private readonly IMobileLeaveRequestService _service;
        private readonly ICurrentUserResolver _currentUserResolver;

        public MobileLeaveRequestsController(
            IMobileLeaveRequestService service,
        ...
        public async Task<IActionResult> Get([FromQuery] MobileRequestListQuery query, CancellationToken ct)
        {
            ...
            try
            {
                ...
                return Ok(new MobileDataResponse<IReadOnlyList<MobileLeaveRequestDto>>(data));
            }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] MobileLeaveRequestCreateDto? request, CancellationToken ct)
        {
            ...
            try
            {
                ...
                return Ok(new MobileDataResponse<MobileLeaveRequestDto>(data));
            }
            catch (MobileRequestValidationException ex)
            {
                return BadRequest(new { message = ex.Message });
        ...
        public async Task<IActionResult> Meta(CancellationToken ct)
        {
            ...
            try
            {
                ...
                return Ok(new MobileDataResponse<MobileLeaveRequestMetaDto>(data));
            }
            catch (MobileRequestValidationException ex)
            {
                return BadRequest(new { message = ex.Message });
